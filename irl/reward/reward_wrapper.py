...
from irl.reward.reward_function import State, StateAction, StateActionState, FeatureBasedRewardFunction
        ...
        if isinstance(self.reward_function, FeatureBasedRewardFunction):
            ...
            if self.reward_function.action_in_domain:
                if self.reward_function.next_state_in_domain:
                    rew_input = StateActionState(self.current_state, action, next_state)
                else:
